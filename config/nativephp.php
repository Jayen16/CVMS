...
return [
     ...
     */
    'app_id' => env('NATIVEPHP_APP_ID', 'ph.gov.indang.cvms'),
     ...
     */
    'description' => env('NATIVEPHP_APP_DESCRIPTION', 'Clinic Vaccination Management System desktop app with offline-ready local SQLite support'),
