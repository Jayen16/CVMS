...
use App\Http\Middleware\RequireParentPrivacyAcknowledgment;
...
return Application::configure(basePath: dirname(__DIR__))
    ...
    ->withMiddleware(function (Middleware $middleware): void {
        $middleware->alias([
            'unactivated.installation' => RequireUnactivatedInstallation::class,
            'parent.privacy' => RequireParentPrivacyAcknowledgment::class,
        ]);
    })
