    ...
    <div class="page-heading">
        ...
        <div class="flex flex-wrap gap-2">
            ...
            @elseif (auth()->user()->isAdmin())
                <a href="{{ route('nurses.index') }}" class="app-button-primary" wire:navigate>Manage nurses</a>
            @endif
        </div>
    </div>
        ...
        <div class="mt-4 grid gap-4 md:grid-cols-2">
            ...
            <div class="app-card flex items-center justify-between">
                ...
                <div class="flex flex-wrap gap-2">
                    ...
                    <a href="{{ route('duplicates.index') }}" class="app-button-secondary" wire:navigate>Duplicates</a>
                </div>
            </div>
        </div>
