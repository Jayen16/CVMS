<x-layouts::app :title="__('Duplicate Child Detection')">
    <div class="app-page">
                            ...
                            <tbody>
                                @foreach ($group['children'] as $child)
                                    <tr class="app-table-row">
                                        <td><a href="{{ route('children.show', $child) }}" class="font-semibold text-teal-700 hover:underline dark:text-teal-300">{{ $child->full_name }}</a></td>
