<x-layouts::app.sidebar :title="'Locations'">
    <flux:main>
        <div class="app-page space-y-6 p-6">
            ...
            <form method="GET" class="app-card relative z-20 grid gap-4 overflow-visible p-4 md:grid-cols-4">
                ...
                <div class="flex gap-2 md:col-span-4"><button class="app-button-primary">Apply filters</button><a href="{{ route('groups.index') }}" class="app-button-secondary">Clear</a></div>
            </form>
